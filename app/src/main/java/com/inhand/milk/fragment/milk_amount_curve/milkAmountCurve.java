...
public class milkAmountCurve extends TitleFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.milk_amount_curve, container, false);
        initVariable();
        return mView;
    }
    ...
    private void initVariable() {
        ...
        selectColor = getResources().getColor(R.color.milk_amount_curve_checked_color);
        noSelectColor = getResources().getColor(R.color.milk_amount_curve_unchecked_color);
    ...
    protected void setTitle() {
        ...
        ImageView backIcon = (ImageView) mView.findViewById(R.id.title_left_icon);
    ...
    protected void addPaperView(int width, List<View> listViews, List<OnePaper> onePapers) {
        // TODO Auto-generated method stub
        OnePaper paper;
        int margin = 2 * getResources().getDimensionPixelOffset(R.dimen.temperature_milk_excle_margin);
        paper = new curveDay(getActivity(), width - margin);
        onePapers.add(paper);
        listViews.add(paper.getPaper());

        paper = new curveWeek(getActivity(), width - margin);
        onePapers.add(paper);
        listViews.add(paper.getPaper());

        paper = new curveMonth(getActivity(), width - margin);
        onePapers.add(paper);
        listViews.add(paper.getPaper());
    }
